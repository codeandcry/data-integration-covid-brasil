...
with DAG(
    dag_id="minio_import_bucket_vacinacao",
    schedule=None,
    ...
    @task(task_id="send-file-vacinacao-covid-pb")
    def send_file_vacinacao_covid_pb(ds=None, **kwargs):
        client.fput_object("vacinacao", "vacinacao-covid-pb.csv", "/opt/notebooks/vacinacao-covid-pb.csv")
        print("Arquivo enviado com sucesso!")
    send_file_vacinacao_covid_pb_step = send_file_vacinacao_covid_pb()

check_minio_connection_step >> check_minio_buckets_step
check_minio_buckets_step >> send_file_vacinacao_covid_pb_step